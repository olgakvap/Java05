...
//    Результат деления m на k = …, а остаток от деления  = …
    ...
    public static int countAveSpeed(double distance, double time) {//distance 137
    ...
    public static void main(String[] args) {
        ...
        System.out.println(doubleTheValue(6));//12

        int b = doubleTheValue(6);//12
        System.out.println(b);

        System.out.println(tripleTheValue(5));//15

        int sum = doubleTheValue(6) + tripleTheValue(5);//27

        System.out.println(sum);

        System.out.println(text);

        System.out.println("text" + 6);//text6
...
//        String text2 = printKLMActions(k, l, "k", "l");
        ...
        int total = countAveSpeed(200.45, 1.5) + countAveSpeed(12.5, 2.75);//distance 137
